...
if(popContainer!=null){window.inputSelectorForColorPicker=selector;let element=document.querySelector("button"+selector);if(element!=null){const dem=element.getBoundingClientRect();if(popContainer.style.display=="none"){console.log(popContainer.style);console.log(dem);popContainer.style.position="fixed";popContainer.style.left=`${dem.x-110}px`;popContainer.style.top=`${dem.y+dem.height}px`;console.log(popContainer.style);popContainer.style.display="block";}else{popContainer.style.display="none";}}}}
